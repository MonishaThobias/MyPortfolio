...
import logo from '../assets/images/Mary Monisha.png'
//import ThemeToggle from "./ThemeToggle";
//import cv from 'CV/Monisha_CV.pdf'
...
export default function Navbar() {
  return (
    <Disclosure as="nav" className="bg-gray-900 fixed w-full z-50 shadow">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="flex items-center">
                 <img src={logo} alt="Mary Monisha Logo" className="w-16 h-16"/> 
                <span className="text-xl font-bold text-white">Mary Monisha.T
                </span>
              </div>
